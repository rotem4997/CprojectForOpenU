assembler: main.o first_pass.o structLabels.o struct_ext.o second_pass.o utils.o preprocessor.o
	gcc -g -ansi -Wall -pedantic main.o first_pass.o struct_ext.o second_pass.o utils.o structLabels.o preprocessor.o -lm -o assembler
...
preprocessor.o: preprocessor.c prototypes.h assembler.h ext_vars.h structs.h preprocessor.h
