...
/**Functions that are used for parsing tokens and moving within them */
...
/**Functions that are used for creating files with matching extentions */
...
/** Functions of external labels and linked list */
